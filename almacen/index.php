...
<script>
                    ...
                    <tr>
                        ...
                        <td>
                            <center>
                                ...
                                <button class="btn btn-danger btn-sm" onclick="eliminarProducto(${prod.id_producto})" class="btn-eliminar"><i class="fa fa-trash"Eliminar</button>
                            </center>
                        </td>
                    </tr>`;
                });
    ...
    async function eliminarProducto(id) {
        ...
        try {
            ...
            // 1. Verificar si la respuesta HTTP fue exitosa
            if (!resp.ok) {
            ...
            if (data.success) {
                ...
                window.location.reload(true); // <-- aquí recargas la página
            } else {
            ...
            if (error instanceof SyntaxError) {
                alert("Error: La respuesta del servidor no es un JSON válido. Revisa el backend.");
            } else {
                alert("Error de conexión al intentar desactivar el producto. Revisa la consola para más detalles.");
            }
        }
    }
