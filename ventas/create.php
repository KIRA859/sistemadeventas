                                                ...
                                                <td>
                                                    <center>
                                                        <form action="../app/controllers/ventas/borrar_carrito.php" method="post">
                                                            ...
                                                            <button type="submit" class="btn-danger btn-sm"><i class="fa fa-trash"></i> Borrar</button>
                                                        </form>
                                                    </center>
                                                </td>
                ...
                <div class="col-md-9">
                    <div class="card card-outline card-primary">
                        ...
                        <div class="card-body">
                            ...
                            <!-- modal para buscar los datos de los clientes-->
                                ...
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                        <div class="modal-header" style="background-color: #1d36b6;color: white">
                                            ...
                                            <button id="" type="button" class="btn btn-warning" data-toggle="modal"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label for="">Numero celular del cliente</label>
                    ...
                    <div class="card card-outline card-primary">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="total_cancelar"
                                    style="text-align: center;background-color:#fff819" value="<?php echo $precio_total ?>" disabled>
                            </div>
