    ...
    fetch("../api/compras/listado.php")
        ...
        .then(data => {
            ...
            if (Array.isArray(data) && data.length > 0) {
                            ...
                            <td>
                                <center>
                                    <div class="btn-group">
                                        ...
                                        <a href="update.php?id=${compra.id_compra}" class="btn btn-success btn-sm">
                                            <i class="fa fa-pencil-alt"></i> Editar
                                        </a>
                                        <a href="delete.php?id=${compra.id_compra}" class="btn btn-danger btn-sm">
                ...
                tbody.innerHTML = `<tr><td colspan="10" class="text-center text-danger">No se encontraron compras</td></tr>`;
            }
